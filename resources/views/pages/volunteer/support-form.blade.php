...
<form action="#" method="POST" id="xs-contact-form">
  ...
  <div class="xs-input-group xs-mb-30">
    ...
    <div class="xs-input-group-addon">
      <input type="text" name="profession" id="xs_contact_subject" class="xs-input-control" placeholder="{{_t('How would you like to support PRSF...')}}'">
    </div>
  </div>
  ...
  <div class="xs-massage-group xs-mb-30">
    ...
    <div class="xs-massage-group-addon">
      <i class="fa fa-pencil color-green xs-input-addon"></i>
      <textarea name="massage" id="x_contact_massage" class="xs-textarea-control" cols="30" rows="10" placeholder="{{_t('Enter your additional informtion...')}}'"></textarea>
    </div>
  </div>
