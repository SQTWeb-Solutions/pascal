        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="width:600; background-color: #ffffff; color: #514d6a; padding: 40px; margin-top: 40px; line-height: 28px;" bgcolor="#ffffff">
          <tr>
            <td style="text-align: center; vertical-align: top;">
              <img src="{{ $message->embed('img/logo-normal.png') }}" alt="PRSF" style="border:none; display:inline-block;" height="50" >
            </td>
          </tr>
          ...
          <tr>
            <td style="text-align: center; padding-top: 30px; padding-bottom: 40px;">
              <a href="{{ route('admin.password.reset', $token) }}" style="letter-spacing: -1px; font-family: 'Open Sans',Helvetica,Arial,sans-serif; text-decoration: none; display: inline-block; line-height: 70px; padding-left: 30px; padding-right: 30px; border-radius: 3px; font-size: 24px; color: #fff; background-color: #27cbcc;" target="_blank">
                Reset Password Now
              </a>
            </td>
          </tr>
          <tr>
            <td style="text-align: center; padding-top: 30px; padding-bottom: 10px; font-size:14px; color:#000;">
              <p>Note: If you did not request a password reset, no further action is required.</p>
            </td>
          </tr>
        </table>
      </td>
